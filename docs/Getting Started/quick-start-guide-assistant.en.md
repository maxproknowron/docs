...
??? info "Already have a serial number or machine QR code?"
    ...
    If you already have a serial number or KNOWRON QR code, that means that your organization has been working with KNOWRON for a little bit longer. That's great! All your machine data should be available for you to access.
